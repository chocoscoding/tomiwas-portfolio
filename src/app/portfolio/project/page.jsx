  ...
  useGSAP(
    () => {
      ...
      copyH3Refs.current.forEach((h3) => {
        const split = new SplitText(h3, { type: "lines" });
        ...
        <div className="project-content">
          ...
          <div className="copy">
            <h3 ref={(el) => (copyH3Refs.current[0] = el)}>
              ...
              bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id
              metus massa, ut blandit odio. Proin quis tortor orci. Etiam at risus et justo dignissim congue. Donec congue lacinia dui, a
              porttitor lectus condimentum laoreet. Nunc eu ullamcorper orci. Quisque eget odio ac lectus vestibulum faucibus eget in metus.
          ...
          <div className="copy">
            <h3 ref={(el) => (copyH3Refs.current[1] = el)}>
              ...
              lacus ornare ante, ac egestas est urna sit amet arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per
              inceptos himenaeos.
            </h3>
          </div>
          ...
          <div className="copy">
            <h3 ref={(el) => (copyH3Refs.current[2] = el)}>
              ...
              venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id metus massa,
              ut blandit odio. Proin quis tortor orci. Etiam at risus et justo dignissim congue. Donec congue lacinia dui, a porttitor
              lectus condimentum laoreet. Nunc eu ullamcorper orci. Quisque eget odio ac lectus vestibulum faucibus eget in metus. In
